...
unsigned int nTargetSpacing = 2 * 60; // 2 minutes per block
...
const string strMessageMagic = "HardCider Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HardCider", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "24 June 2014 U.S. shortage of spitter apples threatens boom in hard cider - Chicago Tribune";
        CTransaction txNew;
        txNew.nTime = 1403747964;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1403747964 ;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 2452684 : 216178;

        //// debug print


        assert(block.hashMerkleRoot == uint256("0x7677697bef039e369d523e740044b3b00853d326e86e69ca6e0f2beae9a1673f"));
